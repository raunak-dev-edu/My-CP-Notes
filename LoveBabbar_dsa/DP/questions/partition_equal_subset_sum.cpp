...
/*
-> Partition eqaul subset sum -Given an array arr[] of size N, check if it can be partitioned into two parts such that the sum of elements in both parts is the same.
...
bool solveOpt(int N, int arr[], int total){
